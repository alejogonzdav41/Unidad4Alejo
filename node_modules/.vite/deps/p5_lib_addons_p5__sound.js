...
(function(modules) {
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_RESULT__ = (function() {
      ...
      return a.prototype.set = function(t, e2, n) {
        ...
        var e2 = [];
        if (this.isUndef(t.defaults) || (e2 = Object.keys(t.defaults)), !this.isUndef(t._super)) for (var n = this._collectDefaults(t._super), o = 0; o < n.length; o++) -1 === e2.indexOf(n[o]) && e2.push(n[o]);
        return e2;
      }, a.prototype.toString = function() {
        for (var t in a) {
          var e2 = t[0].match(/^[A-Z]$/), n = a[t] === this.constructor;
          if (this.isFunction(a[t]) && e2 && n) return t;
        }
        return "Tone";
        ...
        if (1 < arguments.length) for (var t = arguments[0], e2 = 1; e2 < arguments.length; e2++) {
          var n = arguments[e2];
          t.connect(n), t = n;
        }
        return this;
      }, a.prototype.chain = function() {
        if (0 < arguments.length) for (var t = this, e2 = 0; e2 < arguments.length; e2++) {
          var n = arguments[e2];
          t.connect(n), t = n;
        }
        return this;
        ...
        if (this.isObject(t) && this.isObject(e2)) {
          var n = {};
          for (var o in t) n[o] = this.defaultArg(e2[o], t[o]);
          for (var i in e2) n[i] = this.defaultArg(t[i], e2[i]);
          return n;
        }
        ...
        else for (var i = 0; i < e2.length; i++) o[e2[i]] = t[i];
        ...
        if (Array.isArray(t)) for (var e2 = 0; e2 < t.length; e2++) this._readOnly(t[e2]);
        else Object.defineProperty(this, t, { writable: false, enumerable: true });
      }, a.prototype._writable = function(t) {
        if (Array.isArray(t)) for (var e2 = 0; e2 < t.length; e2++) this._writable(t[e2]);
        else Object.defineProperty(this, t, { writable: true });
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(15)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(e) {
      ...
      return e.WaveShaper = function(e2, t) {
        ...
        if (-1 === ["none", "2x", "4x"].indexOf(e2)) throw new RangeError("Tone.WaveShaper: oversampling must be either 'none', '2x', or '4x'");
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(14)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(o) {
      function t(e, t2, n) {
        if (e.input) Array.isArray(e.input) ? (o.prototype.isUndef(n) && (n = 0), this.connect(e.input[n])) : this.connect(e.input, t2, n);
        else try {
      ...
      return !window.hasOwnProperty("AudioContext") && window.hasOwnProperty("webkitAudioContext") && (window.AudioContext = window.webkitAudioContext), o.Context = function(t2) {
        for (var e in o.Emitter.call(this), t2 = t2 || new window.AudioContext(), this._context = t2, this._context) this._defineProperty(this._context, e);
        ...
        if (this._constants[t2]) return this._constants[t2];
        for (var e = this._context.createBuffer(1, 128, this._context.sampleRate), n = e.getChannelData(0), o2 = 0; o2 < n.length; o2++) n[o2] = t2;
        ...
        var e = t2;
        if (this._latencyHint = t2, this.isString(t2)) switch (t2) {
          case "interactive":
        ...
        if (e && e.input && Array.isArray(e.input)) o.prototype.isUndef(n) && (n = 0), this.disconnect(e.input[n], t2, n);
        else if (e && e.input) this.disconnect(e.input, t2, n);
        else try {
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(o) {
      ...
      return o.Emitter = function() {
        ...
        for (var i = t.split(/\W+/), r = 0; r < i.length; r++) if (t = i[r], this._events.hasOwnProperty(t)) if (o.prototype.isUndef(e)) this._events[t] = [];
      ...
      return o.Time = function(t, e) {
        ...
        for (var o2 = this._notationToUnits(e[e.length - 1]), n = "", i = 0; i < e.length; i++) {
          ...
          if (1 - s % 1 < 1e-6 && (s += 1e-6), 0 < (s = Math.floor(s))) {
            if (n += 1 === s ? e[i] : s.toString() + "*" + e[i], (t -= s * r) < o2) break;
            n += " + ";
          }
        }
        return "" === n && (n = "0"), n;
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(n) {
      return n.TimeBase = function(e, t) {
        ...
        if (!this.isUndef(e)) for (var n2 in t) {
          var i = t[n2];
        ...
        for (var n2 = e.peek(); n2 && this._matchGroup(n2, this._binaryExpressions, t); ) r = (n2 = e.next()).method.bind(this, r, this._parseBinary(e, t - 1)), n2 = e.peek();
        return r;
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(a) {
      ...
      return a.Param = function() {
        ...
        for (var a2 = 0; a2 < t.length; a2++) t[a2] = this._fromUnits(t[a2]);
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(i) {
      ...
      return i.Timeline = function() {
        ...
        if (0 < i2 && this._timeline[i2 - 1].time < e) return this._timeline[i2 - 1];
        var t = this._search(e);
        return 0 <= t - 1 ? this._timeline[t - 1] : null;
      }, i.Timeline.prototype.cancel = function(e) {
        if (1 < this._timeline.length) {
          var i2 = this._search(e);
          if (0 <= i2) if (this._timeline[i2].time === e) {
            for (var t = i2; 0 <= t && this._timeline[t].time === e; t--) i2 = t;
            this._timeline = this._timeline.slice(0, i2);
          } else this._timeline = this._timeline.slice(0, i2 + 1);
          else this._timeline = [];
        ...
        for (var n = i2; n <= t; n++) e(this._timeline[n]);
    ...
    !(function(e, t) {
      ...
      return r.prototype._moved = function(e) {
        ...
        return (function e2(t2, n2, i2) {
          if (Array.isArray(t2) || NodeList && t2 instanceof NodeList) for (var d2 = 0; d2 < t2.length; d2++) e2(t2[d2], n2, i2);
          else if ("string" == typeof t2) e2(document.querySelectorAll(t2), n2, i2);
          else if (t2.jquery && "function" == typeof t2.toArray) e2(t2.toArray(), n2, i2);
          else if (Element && t2 instanceof Element) {
            var o2 = new r(t2, i2);
            n2.push(o2);
          }
        })(e = e || document.body, d, t), i.then(function() {
          for (var e2 = 0; e2 < d.length; e2++) d[e2].dispose();
          d = null, n && n();
        }), i;
      };
    });
  ...
  (function(module, exports) {
    !(function() {
      ...
      function a(e2) {
        for (var t = [], r = 0; r < e2.numberOfChannels; r++) t[r] = e2.getChannelData(r);
        return t;
      }
      function f(e2) {
      ...
      "function" != typeof AudioWorkletNode && (self.AudioWorkletNode = function(e2, t, r) {
        ...
        if (n.parameters = /* @__PURE__ */ new Map(), o.properties) for (var i = 0; i < o.properties.length; i++) {
        ...
        return fetch(e2).then(function(e3) {
          if (!e3.ok) throw Error(e3.status);
          return e3.text();
        }).then(function(e3) {
          var r = { sampleRate: 0, currentTime: 0, AudioWorkletProcessor: function() {
            ...
            for (var s2 in o2) s2 in e4 || "eval" === s2 || (i += ",", i += s2);
            for (var a2 in e4) i += ",", i += a2, i += "=self.", i += a2;
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(17)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(o) {
      o.Frequency = function(e, t) {
        ...
        return this._expr = (function(e2, t) {
          for (var r = e2(), n2 = [], o2 = 0; o2 < t.length; o2++) n2[o2] = r * this.intervalToFrequencyRatio(t[o2]);
          return n2;
        }).bind(this, this._expr, e), this;
  ...
  (function(module, exports, __webpack_require__) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(4), __webpack_require__(13), __webpack_require__(1), __webpack_require__(33), __webpack_require__(21), __webpack_require__(34), __webpack_require__(20), __webpack_require__(35), __webpack_require__(36), __webpack_require__(37)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(p) {
      ...
      return p.Expr = function() {
        ...
        for (var r2 = 0; r2 < e; r2++) this.input[r2] = this.context.createGain();
        ...
        if (null !== n) for (var t2 = 0; t2 < n.length; t2++) {
          var o2 = parseInt(n[t2].substr(1)) + 1;
          r2 = Math.max(r2, o2);
        }
        return r2;
      }, p.Expr.prototype._replacements = function(e) {
        for (var n = e.shift(), r2 = 0; r2 < e.length; r2++) n = n.replace(/\%/i, e[r2]);
        return n;
        ...
        function o2(e2) {
          for (var n2 in p.Expr._Expressions) {
            ...
            for (var t3 in r3) {
              ...
              if (null !== a) return { type: n2, value: a[0], method: o3.method };
            }
          }
        ...
        function o2(e2, n, r3) {
          ...
          if (!a(e2)) for (var o3 in t3) {
            var i3 = t3[o3];
            if (i3.regexp.test(e2.value)) {
              if (a(r3)) return true;
              if (i3.precedence === r3) return true;
            }
          }
          return false;
        }
        function i2(e2) {
          ...
          a(e2) && (e2 = 5), n = e2 < 0 ? (function e3() {
            var n2, r4;
            n2 = t2.peek();
            if (o2(n2, "unary")) return n2 = t2.next(), r4 = e3(), { operator: n2.value, method: n2.method, args: [r4] };
            return s();
          })() : i2(e2 - 1);
          for (var r3 = t2.peek(); o2(r3, "binary", e2); ) n = { operator: (r3 = t2.next()).value, method: r3.method, args: [n, i2(e2 - 1)] }, r3 = t2.peek();
          return n;
        }
        function s() {
          var e2, n;
          if (e2 = t2.peek(), a(e2)) throw new SyntaxError("Tone.Expr: Unexpected termination of expression");
          if ("func" === e2.type) return (function(e3) {
            var n2 = [];
            if (!r2(t2.next(), "(")) throw new SyntaxError('Tone.Expr: Expected ( in a function call "' + e3.value + '"');
            r2(t2.peek(), ")") || (n2 = (function() {
              var e4, n3 = [];
              for (; e4 = i2(), !a(e4) && (n3.push(e4), r2(t2.peek(), ",")); ) t2.next();
              return n3;
            })());
            if (r2(t2.next(), ")")) return { method: e3.method, args: n2, name };
            throw new SyntaxError('Tone.Expr: Expected ) in a function call "' + e3.value + '"');
          })(e2 = t2.next());
          if ("value" === e2.type) return { method: (e2 = t2.next()).method, args: e2.value };
          if (r2(e2, "(")) {
            if (t2.next(), n = i2(), !r2(e2 = t2.next(), ")")) throw new SyntaxError("Expected )");
            return n;
          }
